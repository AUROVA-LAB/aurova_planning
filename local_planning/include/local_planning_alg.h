 ...
 *
 */
class LocalPlanningAlgorithm
{
  protected:
   /**
    * \brief define config type
    *
    * Define a Config type with the LocalPlanningConfig. All driver implementations
  ...
  public:
    ...
    * will then use the same variable type Config.
    */
    typedef local_planning::LocalPlanningConfig Config;
    ...
    */
    ...
    // here define all local_planning_alg interface methods to retrieve and set
